...
// Finds the best-scoring closed triangle in the track: three chronologically
...
//     triangle at all;
//   - the SCORED distance is (perimeter − gap), not the raw perimeter;
//   - "FAI triangle" requires every leg ≥28% of the perimeter;
//   - a tight closing gap (≤5% of the perimeter) gives a bonus multiplier
...
function estimateTriangleDistance(track, targetPoints = 400) {
  ...
  // unabhängig voneinander mitgeführt — die jeweils gewinnende Form kann
  // sich unterscheiden.
  let bestFlat = null, bestFlatPoints = -1;
  let bestFai = null, bestFaiPoints = -1;
  for (let i = 0; i < n; i++) {
    for (let j = i + 1; j < n; j++) {
      for (let k = j + 1; k < n; k++) {
  ...
  const overallIsFai = fai && fai.points >= flach.points;
  const overall = overallIsFai ? fai : flach;
  return { length: overall.length, points: overall.points, category: overallIsFai ? "fai" : "flach", path: overall.path, flach, fai };
}
...
{ id: "v3", label: "Artik", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v10", label: "Pi3", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v11", label: "BiGolden", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v12", label: "Mentor", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v13", label: "Mistral", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v14", label: "Zenith", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v15", label: "HP927", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v16", label: "Xi", type: "image", dataUrl: "data:image/png;base64," },
{ id: "v17", label: "Vibe", type: "image", dataUrl: "data:image/png;base64," }
];
...
function FlightMap({ flight, highlightRange, onPlaybackPositionChange, onPlaybackActiveChange, onPlaybackPhaseChange, controlsSlot, isWide, onRoutePointChange, onRoutePointAdd, onRoutePointDelete, gpsvColorBy, onGpsvColorByChange }) {
  ...
  // Which glider marker to use — automatisch anhand des Schirm-Namens
  // dieses Flugs bestimmt: das erste Icon aus GLIDER_VARIANTS, dessen Label
  // im Schirm-Namen vorkommt (z.B. "Mentor" passt auf "Ozone Mentor 7").
  // Ohne Treffer wird auf "Eigenes Symbol" zurückgefallen. Re-read on focus
  // so a change to the custom-symbol setting (a different page) takes
  // effect without needing a full reload of this one. gliderIcon carries
  // either { type:"image", value:url } or { type:"text", value:char } so
  // the marker-creation code below can render the right kind without
  // needing to know the full variant list.
  const [gliderIcon, setGliderIcon] = useState({ type: "text", value: "★" });
  useEffect(() => {
    let cancelled = false;
    const load = async () => {
      try {
        ...
        if (!cancelled) setGliderIcon({ type: "text", value });
...
// Matching flex-basis percentages allein reichte auf manchen Geräten nicht
// für pixelgleiche Kacheln in diesem Panel — <input> und <button> haben in
// Safari leicht unterschiedliche Standard-Metriken, und eine Höhe nur über
// Padding+Zeilenhöhe zu erzeugen ist entsprechend fragil. Jede Kachel in
// den drei Zeilen (Suchen/Sortieren/Reihenfolge, Gr. 1°, Gr. 2°) bekommt
// deshalb explizit dieselbe feste Höhe statt einer aus Inhalt/Padding
// abgeleiteten.
    ...
    <div onClick={selectMode ? ()=>onToggleSelect(f.id) : onClick}
      ...
      <div style={{flex:1,minWidth:0}}>
        ...
        <div style={{fontSize:11,color:"rgba(232,244,253,0.4)",display:"flex",alignItems:"baseline",whiteSpace:"nowrap",overflow:"hidden"}}>
          <span style={{flexShrink:0}}>{f.date} · <span style={{color:"#f87171"}}>{f.site||"—"}</span></span>
    ...
    <div style={{position:"relative"}}>
      <div style={{position:"relative",height:PANEL_TILE_HEIGHT,boxSizing:"border-box",display:"flex",alignItems:"center",background:"rgba(255,255,255,0.07)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:10,padding:"0 34px 0 12px"}}>
        <input value={filterText} onChange={e=>setFilterText(e.target.value)} onFocus={()=>setAdvOpen(true)} placeholder="🔍 Suchen…"
          style={{flex:1,minWidth:0,width:"100%",height:"100%",background:"transparent",border:"none",outline:"none",padding:0,margin:0,color:"#e8f4fd",fontSize:12,boxSizing:"border-box",fontFamily:"inherit"}} />
        {filterText && (
...
function StaticField({label, value, unit, valueColor}) {
  return (
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 0",borderBottom:"1px solid rgba(255,255,255,0.04)"}}>
      ...
      <span style={{fontSize:13,fontWeight:500,color:value?(valueColor||"#e8f4fd"):"rgba(232,244,253,0.25)",textAlign:"right"}}>
          ...
          <div id="flugdaten-section" style={{background:"rgba(255,255,255,0.04)",borderRadius:14,padding:"13px 15px",marginBottom:11,border:"1px solid rgba(255,255,255,0.06)"}}>
            ...
            {(() => {
              ...
              const rows = {
                ...
                distanz: () => <InlineField label="Distanz"     value={getDisplayDistance(fl)} onSave={v=>saveComputedField(fl,{totalDist:parseFloat(v)||0,customFields:{distKm:v}})} unit="km" valueColor="#709dcc" />,
                maxFreieStrecke: () => <StaticField label="Max. Freie Strecke" value={freeDistEstimate?.length>0 ? `${freeDistEstimate.length.toFixed(2)} km (${freeDistEstimate.length.toFixed(1)} Pkt.)` : ""} valueColor="#709dcc" />,
                maxFlachesDreieck: () => <StaticField label="Max. Flaches Dreieck" value={triangleEstimate?.flach ? `${triangleEstimate.flach.length.toFixed(2)} km (${triangleEstimate.flach.points.toFixed(1)} Pkt.)` : ""} valueColor="#709dcc" />,
                maxFaiDreieck: () => <StaticField label="Max. FAI-Dreieck" value={triangleEstimate?.fai ? `${triangleEstimate.fai.length.toFixed(2)} km (${triangleEstimate.fai.points.toFixed(1)} Pkt.)` : ""} valueColor="#709dcc" />,
                routenTyp: () => <InlineField label="Routenart"   value={fl.customFields?.routenTyp}
                  ...
                  placeholder={routenTypSuggestion} valueColor="#709dcc" />,
...
function FlugbuchApp() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Dritte, wirklich nur EINMALIGE Nachkorrektur — bewusst NICHT Teil
      // des synchronen Blocks oben: estimateTriangleDistance braucht pro
      // Flug spürbar Rechenzeit, und bei vielen Flügen mit GPS-Track hat
      // das die App vorher komplett einfrieren lassen (blockierte den
      // Hauptthread ununterbrochen, bevor überhaupt etwas gerendert wurde).
      // Läuft daher erst NACH dem ersten Render, Flug für Flug mit einer
      // Pause dazwischen (gibt den Hauptthread jedes Mal kurz frei), und
      // aktualisiert die Liste laufend statt erst ganz am Schluss — die
      // App bleibt währenddessen bedienbar. Rührt nur Flüge an, deren
      // Routenart noch exakt einem der drei automatisch vergebenen Werte
      // entspricht (leer zählt als "noch nie gesetzt") — von Hand
      // eingetragener/geänderter Text bleibt unangetastet. Aktualisiert
      // routePts nur zusammen mit einer tatsächlichen Änderung der
      // Routenart, um von Hand auf der Karte verschobene Punkte bei sonst
      // gleicher Einstufung nicht zu überschreiben. service:
      // triangleFixDone_v1 wird erst ganz am Ende gesetzt, damit ein
      // vorzeitig geschlossener Tab beim nächsten Start einfach weitermacht
      // (bereits korrigierte Flüge sind für den erneuten Durchlauf ein
      // No-op).
      (async () => {
        ...
        if (triangleFixDone) return;
        const AUTO_ROUTE_VALUES = ["FAI-Dreieck", "Flaches Dreieck", "Freie Strecke"];
        const candidates = migrated.filter(f => f.track && f.track.length > 1);
        for (let idx = 0; idx < candidates.length; idx++) {
          const f = candidates[idx];
          try {
            const cf = f.customFields || {};
            const currentTyp = (cf.routenTyp||"").trim();
            if (currentTyp && !AUTO_ROUTE_VALUES.includes(currentTyp)) continue;
            ...
            if (newRouteType !== currentTyp) {
              const nextRoutePts = isTriangle ? triangle.path : freeDist.path;
              const updated = { ...f, customFields: { ...cf, routenTyp: newRouteType }, routePts: nextRoutePts };
          ...
          // Hauptthread nach jedem Flug kurz freigeben, statt alle
          // Flüge in einem einzigen ununterbrochenen Rechenblock
          // abzuarbeiten.
        ...
        <div style={{padding:"12px 16px 6px",position:"relative"}}>
          <div style={{display:"flex",gap:6,alignItems:"flex-start"}}>
            ...
            <button onClick={()=>setSortDir(d=>d==="asc"?"desc":"asc")}
              ...
              style={{flexShrink:0,width:32,height:PANEL_TILE_HEIGHT,boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"center",padding:0,background:"rgba(255,255,255,0.06)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:10,color:"#fff",fontSize:16,fontWeight:700,cursor:"pointer"}}>
              {sortDir==="asc"?"↑":"↓"}
            </button>
          </div>
              ...
              <div key={level} style={{marginTop:6,position:"relative",display:"flex",gap:6}}>
                ...
                {groupId && (
                  <button onClick={()=>{
                    ...
                    style={{flexShrink:0,width:32,height:PANEL_TILE_HEIGHT,boxSizing:"border-box",display:"flex",alignItems:"center",justifyContent:"center",padding:0,background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:10,color:"rgba(232,244,253,0.6)",fontSize:15,fontWeight:700,cursor:"pointer"}}>
                    {collapsedSet.size===0?"➖":"➕"}
                  </button>
                )}
                {showMenu && (
