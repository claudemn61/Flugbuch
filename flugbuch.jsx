      ...
      <div style={{textAlign:"right",flexShrink:0,marginLeft:8}}>
        {showSortValue ? (
          ...
          <div style={{fontSize:13,fontWeight:600,color:"#7dd3fc",display:"flex",alignItems:"center",justifyContent:"flex-end",gap:4}}>
            {f.rating>=4 && <span style={{color:"rgba(249,115,22,0.75)"}}>{f.rating}⭐️</span>}
      ...
      <div onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"calc(16px + env(safe-area-inset-top, 0px)) 16px 10px"}}>
          ...
          <div style={{display:"flex",gap:8}}>
            ...
            <button onClick={()=>exportFlightsAsCsv([fl], `flug-${fl.name||"export"}`)}
              title="Als CSV exportieren (Numbers/Excel)"
              style={{background:"rgba(125,211,252,0.12)",border:"1px solid rgba(125,211,252,0.25)",borderRadius:20,padding:"6px 12px",color:"#7dd3fc",fontSize:13,cursor:"pointer"}}>⬇ CSV</button>
            {fl.track?.length>1 && (
