...
function KurzContent() {
  return (
    <div className="hilfe-body">
      ...
      <h3>Statistik</h3>
      <p>7 Badges (Passagiere/Hike blenden sich einzeln aus, wenn nicht zutreffend): Schirm · Startplätze · Landeplätze · Passagiere · Hike (gruppiert nach Ort) · Saison (Jahresübersicht + Rekorde) · Graph (öffnet formatfüllend, passt sich dem Querformat an; Gruppiert: Balken zur Flugliste-Gruppierung, X/Y frei wählbar aus allen Flugdatenfeldern, bei Namen alphabetisch/nach Wert sortierbar; Frei: ein Punkt je Flug, gleiche Feldliste, je Achse "Wert" oder "Rang nach der anderen Achse" wählbar für eine sortierte Verteilungskurve — beide Modi mit optionaler Trendlinie, runden Achsen-Ticks, Gr.-2°-Aufschlüsselung, echtem Bereichs-Zoom per Pinch, Achsen-Feldliste per ⚙️ auswählbar/umsortierbar)</p>
      <h3>Reisen</h3>
