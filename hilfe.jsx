...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => (<>
      ...
      <p>Auf der Karte erscheint die Hike-Route grün gestrichelt, neben dem blauen Flug-Track. Die Cine-Wiedergabe kombiniert beide: die Hike-Phase (🥾-Symbol, fixe Ausrichtung) spielt zuerst, pausiert automatisch am Übergang zum Flug, danach läuft die Flug-Phase (🪂) wie gewohnt weiter.</p>
  ...
  return (
    <div className="hilfe-body">
      ...
      <ul>
        ...
        <li>Hike-GPX-Import (🥾, per Datum/Flugnummer/Auswahl zugeordnet), grün auf Karte, kombinierte Wiedergabe (Hike→Pause→Flug), Export "⬇ Hike" im Flugdetail, Löschen über konsolidierte 🗑-Kachel (IGC/GPX Hike/Alles)</li>
