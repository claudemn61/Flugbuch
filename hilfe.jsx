...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => (<>
      ...
      <p>Bei aktiver Suche oder aktiver Darstellung (siehe 3.1) steht neben der Trefferzahl ein aufklappbares Statistik-Feld (▸/▾) mit bis zu 10 Kennzahlen zur aktuellen Auswahl: Zeitraum, Gesamtzeit, Gesamtdistanz, Ø Dauer, Ø Distanz, längster Flug, weitester Flug, grösste Höhe, Anzahl Startplätze, Anzahl Schirme. Bei aufgeklapptem Feld erscheint zusätzlich ein ⚙️-Zahnrad, über das sich auswählen lässt, welche dieser Werte angezeigt werden und in welcher Reihenfolge — an-/abwählen, per ↑/↓ neu anordnen, wie bei den Spalten fürs Kopieren.</p>
  ...
  return (
    <div className="hilfe-body">
      ...
      <ul>
        ...
        <li>Statistik-Feld neben der Flug-Anzahl (bei aktiver Suche oder Darstellung): bis zu 10 Kennzahlen zur aktuellen Auswahl, über ⚙️ einzeln aus-/einblendbar und per ↑/↓ neu anordenbar</li>
