  ...
  return (
    <div className="hilfe-body">
      ...
      <ul>
        ...
        <li>Statistik-Feld neben der Flug-Anzahl (bei aktiver Suche oder Darstellung): 10 Kennzahlen standardmässig aktiv, 5 weitere (Ø Bewertung/Flugtage/Landeplätze/Biplace-Flüge/Ges. Höhengewinn) über ⚙️ dazuwählbar, alle einzeln aus-/einblendbar und per ↑/↓ neu anordenbar</li>
