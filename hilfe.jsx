...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => (<>
      ...
      <p>Das Zahnrad sitzt mittig im schmalen Streifen unter dem Titelfoto, mit der Versionsnummer links und Datum/Zeit der letzten Sicherung rechts (auf iPad/Mac weiterhin auf dem Foto selbst, Version darunter zentriert). Öffnet ein Panel mit: der App-URL (antippen/halten zum Kopieren), ❓ Hilfe (diese Seite), 🪂 Schirme (Auswahl des Kartenmarkers, siehe unten), 📁 Log Files (technisches Fehlerprotokoll) und 📝 Notizen (freies App-weites Notizfeld). Die Datensicherung (Backup) liegt nicht hier, sondern im Flugbuch selbst (siehe 3.3).</p>
