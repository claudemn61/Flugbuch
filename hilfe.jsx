...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => (<>
      ...
      <p>Die Reihenfolge der Gruppen selbst lässt sich frei nach jedem beliebigen Datenfeld bestimmen — nicht nur alphabetisch nach dem Gruppierfeld: der ⇅-Button neben Gr. 1°/Gr. 2° öffnet dieselbe Feldliste wie "Sortieren". Zahlenfelder (Dauer, Distanz, Höhe, Bewertung, …) werden dabei über alle Flüge der Gruppe summiert (z.B. "Schirme nach Gesamt-Flugzeit sortieren"), Textfelder nehmen den alphabetisch ersten Wert in der Gruppe. Ein bereits gewähltes Feld nochmals antippen kehrt die Richtung um (erst absteigend, dann aufsteigend). Jede Ebene hat zusätzlich ein eigenes Alle-ein-/ausklappen (+).</p>
