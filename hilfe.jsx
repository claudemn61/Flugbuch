  ...
  },
  {
    ...
    body: () => (<>
      ...
      <ul>
        ...
        <li>📈 Graph (cyan) — zeigt die gerade in der Flugliste aktive Filterung als Diagramm, zwei umschaltbare Modi: <b>Gruppiert</b> (Balken zur Gr. 1° der Flugliste, X-/Y-Achse danach im Badge frei wählbar — X: dieselben Felder wie Gr. 1°/2° im Flugbuch, Y: Anzahl Flüge oder Gesamt/Ø/Max. jedes numerischen Flugdatenfelds) und <b>Frei</b> (ein Punkt pro Flug, X/Y beide frei aus Datum/Jahr/Monat/Std. oder jedem numerischen Feld wählbar, als Linie oder nur Punkte) — startet automatisch im passenden Modus, je nachdem ob in der Flugliste eine Gr. 1° aktiv ist. Beide Achsen (X in beiden Modi, Y nur Gruppiert) per ⇅ umkehrbar. Ist in der Flugliste Gr. 2° gesetzt, kommt in beiden Modi ein "Aufschlüsseln nach…"-Dropdown dazu, das auf einen einzelnen Gr.-2°-Wert einschränkt. Werte, die bei der gewählten Y-Achse leer/0 sind, lassen sich ausblenden. Echter Bereichs-Zoom per Pinch (zwei Finger verengen den sichtbaren Werte-/Zeitbereich, Balken/Punkte werden dadurch tatsächlich grösser statt nur optisch vergrössert) plus Verschieben (ein Finger), Doppeltipp oder ⤾-Symbol setzt auf die volle Spanne zurück. ↻ bzw. Tippen auf die Bezug-Zeile führt zur Flugliste (inkl. aktuellem Filter) — von dort führt der 📊-Button oben links direkt wieder zurück zum offenen Graph-Badge.</li>
      </ul>
    </>),
  },
  {
