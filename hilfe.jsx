  ...
  return (
    <div className="hilfe-body">
      ...
      <ul>
        ...
        <li>Karte zeigt erkannte Route (freie Strecke/Dreieck) gestrichelt gelb über dem Track; Punkte im Vollbild per Drag verschiebbar, Distanz/Routenart werden dabei live neu berechnet</li>
      </ul>
      <h3>Statistik</h3>
