...
const SECTIONS = [
  ...
  },
  {
    ...
    body: () => (<>
      ...
      <p>Für Hike & Fly: eine separate, eigenständige Wanderroute (z.B. aus Komoot, AllTrails o.ä. exportiert) lässt sich zusätzlich zum eigentlichen Flug-Track speichern. Über die 🥾-Kachel im Import-Menü, per Zeitstempel im GPX automatisch dem passenden Flug (gleiches Datum) zugeordnet. Gibt es mehrere Flüge an diesem Datum, fragt die App nach, welchem die Route zugeordnet werden soll. Kein Flug an diesem Datum vorhanden: kein Import (die Route wird nie zu einem eigenständigen, neuen Flug).</p>
      <p>Export als eigene GPX-Datei im Flugdetail ("⬇ GPX Hike", neben "⬇ IGC" und "⬇ GPX"). Löschen über die konsolidierte 🗑-Kachel im Flugdetail, die zwischen IGC-Track, GPX Hike und dem ganzen Flug wählen lässt.</p>
  ...
  return (
    <div className="hilfe-body">
      ...
      <ul>
        ...
        <li>Hike-GPX-Import (🥾, per Datum zugeordnet), Export "⬇ GPX Hike" im Flugdetail, Löschen über konsolidierte 🗑-Kachel (IGC/GPX Hike/Alles)</li>
