...
function StatChip({ label, value }) {
  return (
    <span style={{fontSize:11,background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:20,padding:"3px 9px",color:"rgba(232,244,253,0.7)",whiteSpace:"nowrap",flexShrink:0}}>
