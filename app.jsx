        ...
        {selectMode && (
          <button onClick={async()=>{
              ...
              try {
                ...
                const cellStyle = "font-family:Helvetica,sans-serif;font-size:10px;";
                ...
                setCopyMsg(`✓ ${chosen.length} Flug${chosen.length!==1?"e":""} kopiert. [DEBUG col0]: "${flightToCsvRow(chosen[0]).split("\t")[0]}"`);
              } catch (e) {
