...
function HomeApp() {
  ...
  const TILES = [
    ...
    },
    {
      ...
      icon: "📊",
      color: "#7a2a3a",
      glow: "rgba(122,42,58,0.32)",
      stats: ["Startplätze", "Landeplätze", "Schirme"],
      href: null,
      ready: false,
    },
    {
      ...
      icon: "🛠️",
      color: "#5c8a6e",
      glow: "rgba(92,138,110,0.3)",
      stats: ["Nächster Check", "Nächstes Packen"],
      href: null,
      ready: false,
    },
    {
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "28px 20px 18px", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 13, color: "rgba(232,244,253,0.4)", marginTop: 2, letterSpacing: 0.5 }}>
          claudemn61
        </div>
      </div>
      ...
      <div style={{ padding: "16px 20px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {TILES.map((t) => (
          ...
          >
            {/* Accent rail */}
            <div style={{ width: 5, background: t.color, opacity: t.ready ? 1 : 0.45, flexShrink: 0 }} />
